...
export function RecipeCard({ recipe }) {
  return (
    <Link
      ...
      className={`${manrope.className} block h-full w-full focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-amber-300`}
    >
      <article className="flex h-full w-full flex-col overflow-hidden rounded-[20px] bg-white shadow-[0_26px_60px_rgba(15,23,42,0.12)] ring-1 ring-slate-100 transition hover:-translate-y-1 hover:shadow-[0_30px_70px_rgba(15,23,42,0.16)]">
        ...
        <div className="flex flex-1 flex-col gap-4 px-6 pb-7 pt-6 font-normal">
          ...
          <div className="mb-[15px] space-y-3">
